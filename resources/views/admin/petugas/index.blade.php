...
<div class="container">
    <h1 class="text-main mb-3">Data Petugas</h1>
    ...
    <form method="GET" action="{{ route('admin.petugas.index') }}" class="d-flex justify-content-between align-items-center flex-wrap mb-3 gap-2">
        ...
        <div class="d-flex justify-content-end">
            <a href="{{ route('admin.petugas.create') }}" class="btn btn-main btn-sm">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                @forelse($users as $user)
                    @php
                        $detail = $user->role === 'admin' ? $user->admin : $user->kepalaDesa;
                    @endphp
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <form action="{{ route('admin.users.destroy', $user->id) }}?from=petugas" method="POST" id="delete-form-{{ $user->id }}">
                                    @csrf
                                    @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="7">Belum ada petugas.</td>
                    </tr>
                @endforelse
